...
<head>
  ...
  <title>Jamur Oka | Registration Page</title>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('backend-assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
